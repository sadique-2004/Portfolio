    ...
    >
      ...
      <div className="section-container relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-[#504953] dark:text-white mb-6" >
              Hi, I'm <span className="bg-gradient-to-r from-primary-500 to-secondary-500 bg-clip-text text-transparent">Md Sadique</span>
            </h1>
            <h1 className="text-2xl sm:text-2xl lg:text-4xl font-bold text-[#504953] dark:text-white mb-6">
              <span ref={typedElement} className="bg-gradient-to-r from-primary-500 to-secondary-500 bg-clip-text text-transparent"></span>
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <a href="#contact" className="px-6 py-2 rounded-full bg-gradient-to-r from-primary-600 to-secondary-600 text-white hover:from-primary-700 hover:to-secondary-700 transition-all duration-300 shadow-lg hover:shadow-primary-500/25">
                Get in Touch
              </a>
              <a
                href="#projects"
